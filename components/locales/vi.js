export const vi = {
  ...
  "firstRunWebTourManageMsg": "Dùng các công cụ này để đổi tên thư mục, di chuyển mục đã chọn, xóa, sắp xếp thư mục, dọn dẹp và bật chế độ chọn.",
  "firstRunWebTourSettingsMsg": "Mở sidebar settings bên phải để đổi ngôn ngữ, theme, kiểu xem, export/import, kiểm tra bookmark và cài đặt ứng dụng.",
