export const vi = {
  ...
  "smartCleanupGroupSuccess": "Đã gom thành công {count} bookmark vào mục {folder}",
  "smartCleanupGroupError": "Lỗi khi tổ chức bookmark.",
  "smartCleanupTagConfirm": "Tự động tạo tag dựa trên tên miền cho tất cả bookmark?",
  ...
  "guideGroupDomain": "Tự động tạo thư mục cho các tên miền có nhiều liên kết và dời chúng vào trong.",
  "smartCleanupAutoTag": "Tự động gắn Tag",
  "guideAutoTag": "Tự động lấy tên miền để làm nhãn (tag) dán vào mỗi bookmark tương ứng.",
  "smartCleanupNotes": "Có ghi chú",
  "smartCleanupDuplicateIntro": "Đây là các bản sao dư. Hành động dọn dẹp sẽ giữ mục có tiêu đề tốt hơn hoặc mới hơn.",
  "smartCleanupDeadIntro": "Hãy quét lại nếu kết quả này có vẻ đã cũ.",
  "smartCleanupStaleIntro": "Bookmark cũ hơn một năm và chưa có lượt mở được ghi nhận.",
  "smartCleanupUntaggedIntro": "Các mục này rất hợp để dùng gợi ý thẻ trong Bookmark Detail.",
  "smartCleanupNextTitle": "Tiếp theo",
  "smartCleanupNextWorkspaces": "Không gian làm việc ghim",
  "smartCleanupNextWorkspacesText": "Lưu view riêng cho Công việc, Học tập, Thiết kế và Cá nhân.",
  "smartCleanupNextNotesSearch": "Tìm trong ghi chú",
  "smartCleanupNextNotesSearchText": "Tìm nội dung ghi chú từ sidebar và Command Palette.",
  "smartCleanupNextPresets": "Preset xuất dữ liệu",
  "smartCleanupNextPresetsText": "Backup, Share Selected, CSV và Netscape chỉ với một lần bấm.",
  "smartCleanupNextHistory": "Lịch sử dọn dẹp",
  "smartCleanupNextHistoryText": "Xem lại các lần dọn dẹp gần đây và khôi phục checkpoint an toàn hơn.",
  "smartCleanupNextRules": "Luật dọn dẹp",
  "smartCleanupNextRulesText": "Chọn ngưỡng bookmark cũ, thư mục được bảo vệ và quy tắc trùng lặp.",
  "smartCleanupNextReminders": "Nhắc xem lại",
  "smartCleanupNextRemindersText": "Nhắc các mục đọc sau quá lâu và bookmark cũ theo lịch.",
  "duplicateMergeTitle": "Gộp bookmark trùng",
  "duplicateMergeSubtitle": "Chọn bookmark muốn giữ trong từng nhóm trùng. Metadata từ các bản bị xóa sẽ được gộp vào bản giữ lại.",
  ...
  "firstRunGuideStep1": "Mở website bất kỳ và bấm biểu tượng ngôi sao trên thanh địa chỉ Chrome.",
  "firstRunGuideStepShortcut": "Dùng Ctrl + D trên Windows/Linux hoặc Command + D trên macOS để lưu nhanh trang hiện tại.",
  "firstRunGuideStep2": "Chọn thư mục, sau đó bấm Done để lưu bookmark.",
  "firstRunGuideStep3": "Mở Zero Bookmark để quản lý, tìm kiếm và sắp xếp bookmark đó.",
  "firstRunSave": "Bắt đầu sử dụng",
  "firstRunTourSettingsTitle": "Mở Settings",
  "firstRunTourSettingsMsg": "Dùng nút này để đổi ngôn ngữ, theme, font, kiểu hiển thị, export/import và các cài đặt ứng dụng.",
  "firstRunTourPanelTitle": "Bảng Settings",
  "firstRunTourPanelMsg": "Mọi thứ được gom ở đây: tùy chọn tiện ích, thao tác bookmark, kiểm tra link/trùng lặp và cài đặt ứng dụng.",
  "firstRunTourWebTitle": "Mở Web View",
  "firstRunTourWebMsg": "Chọn mục này khi bạn muốn mở trang quản lý bookmark đầy đủ, rộng hơn để sắp xếp.",
  "firstRunTourSidePanelTitle": "Mở Side Panel",
  "firstRunTourSidePanelMsg": "Dùng side panel khi bạn muốn xem bookmark bên cạnh tab hiện tại trong lúc duyệt web.",
  "firstRunTourSearchTitle": "Tìm kiếm và lọc",
  "firstRunTourSearchMsg": "Tìm bookmark theo tên, URL, thẻ hoặc ghi chú. Có thể kết hợp với thư mục, sắp xếp và kiểu hiển thị.",
  "firstRunTourBookmarkMenuTitle": "Tùy chọn từng bookmark",
  "firstRunTourBookmarkMenuMsg": "Dùng nút ba chấm trên mỗi bookmark để ghim, chuyển thư mục, đổi tên, xóa, xem chi tiết, quản lý thẻ, tạo QR hoặc đánh dấu yêu thích.",
  "firstRunWebTourSidebarTitle": "Sidebar chính",
  "firstRunWebTourSidebarMsg": "Nút này mở hoặc thu gọn sidebar bên trái. Web view được thiết kế xoay quanh sidebar này để sắp xếp nhanh hơn.",
  "firstRunWebTourCommandTitle": "Command Palette",
  "firstRunWebTourCommandMsg": "Mở lệnh nhanh để tìm kiếm, đổi kiểu xem, dọn dẹp, điều hướng và thao tác bookmark thường dùng.",
  "firstRunWebTourWorkspacesTitle": "Không gian làm việc",
  "firstRunWebTourWorkspacesMsg": "Lưu view hiện tại thành Công việc, Học tập, Thiết kế hoặc Cá nhân để quay lại nhanh.",
  "firstRunWebTourFoldersTitle": "Thư mục",
  "firstRunWebTourFoldersMsg": "Duyệt cây bookmark, tạo thư mục. Đặc biệt, bạn có thể dễ dàng kéo thả bookmark trực tiếp vào các thư mục ở sidebar này với khả năng tùy chỉnh cao.",
  "firstRunWebTourSortTitle": "Sắp xếp và kiểu xem",
  "firstRunWebTourSortMsg": "Chuyển giữa bookmark yêu thích, mới thêm, đã truy cập, thứ tự chữ cái và nhóm theo domain.",
  "firstRunWebTourTagsTitle": "Thẻ",
  "firstRunWebTourTagsMsg": "Lọc theo thẻ, tìm thẻ, xóa thẻ đang chọn hoặc mở trình duyệt toàn bộ thẻ.",
  "firstRunWebTourManageTitle": "Công cụ quản lý",
  "firstRunWebTourManageMsg": "Sử dụng các công cụ này để đổi tên thư mục, di chuyển, xóa nhiều mục, tổ chức thư mục, dọn dẹp và bật tắt chọn hàng loạt.",
  "firstRunWebTourCloudSyncTitle": "Lưu & Đồng bộ Cloud",
  "firstRunWebTourCloudSyncMsg": "Giữ bookmark an toàn và đồng bộ trên nhiều thiết bị bằng cách kết nối với Google Drive.",
  "firstRunWebTourSmartCleanupTitle": "Dọn dẹp thông minh (Smart Cleanup)",
  "firstRunWebTourSmartCleanupMsg": "Tự động gom nhóm tên miền, phát hiện link chết, gộp bookmark trùng và dọn dẹp thư mục rỗng.",
  "firstRunWebTourSettingsMsg": "Mở sidebar cài đặt bên phải để thay đổi ngôn ngữ, theme, chế độ xem, nhập/xuất, và các tùy chọn ứng dụng.",
  "firstRunWebTourPanelMsg": "Sidebar bên phải này chứa tùy chọn tiện ích, thao tác bookmark, hành vi mở nhanh, công cụ kiểm tra và cài đặt ứng dụng.",
