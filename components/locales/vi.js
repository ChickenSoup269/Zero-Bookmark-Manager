export const vi = {
  ...
  duplicateUrlError: "URL này đã tồn tại trong bookmark!",
  errorInvalidFolder: "Không thể xóa thư mục này",
  errorImporting: "Lỗi khi nhập file. Vui lòng kiểm tra console.",
  searchResults: "Kết quả tìm kiếm",
  searchTitle: "Tìm kiếm",
  searchOptions: "Tùy chọn tìm kiếm",
  releaseNotes: "Nhật ký phát hành",
  healthSortMalware: "⚠️ Mã độc",
  ...
  notes: "Ghi chú",
  visits: "Lượt xem",
  folderStudioTitle: "Quản lý & Tối ưu Thư mục",
  tabTreeStudio: "Cây phân cấp",
  tabMergeDuplicates: "Gộp thư mục trùng",
  tabAutoSort: "Sắp xếp tự động",
  tabCleanEmpty: "Dọn thư mục rỗng",
  searchFoldersPh: "Tìm nhanh thư mục...",
  expandAll: "Mở rộng tất cả",
  collapseAll: "Thu gọn tất cả",
  newSubfolder: "Tạo thư mục con",
  folderDetails: "Thông tin thư mục",
  noFolderSelected: "Chọn một thư mục từ cây bên trái để xem chi tiết",
  folderBookmarks: "Bookmark trong thư mục này",
  noBookmarksInFolder: "Không có bookmark nào trong thư mục này",
  safeDeleteFolder: "Xóa thư mục",
  ...
  smartCleanupDeleteEmpty: "Xóa thư mục rỗng",
  ...
  quickOpenWeb: "Toàn trang",
  quickOpenNativePopup: "Popup mặc định",
  ...
  scopeAllBookmarksDesc: "Quét tất cả các bookmark trên toàn trình duyệt",
  ...
  scopeNoFoldersFound: "Không tìm thấy thư mục nào phù hợp",
  scopeEstimatedTime: "Ước tính: ~{0} giây",
  scopePreviewCheckLinks: "Sẽ kiểm tra: {0} liên kết",
  scopePreviewCheckDuplicates: "Sẽ quét: {0} bookmark",
  scopeNoBookmarks: "Không có bookmark nào trong phạm vi đã chọn.",
  scopeStartCheck: "Bắt đầu kiểm tra",
  ...
  sidebarRecent: "Mới lưu (7 ngày)",
  sidebarMostVisited: "Truy cập nhiều",
  sidebarUntagged: "Chưa gắn thẻ",
  smartFolderResults: "Thư mục động",
  ...
  fontSansSerif: "Aa: Sans-Serif (Mặc định)",
  ...
  lineHidden: "Ẩn",
  lineCustom: "Tùy chỉnh",
  headerLineColor: "Màu",
  headerLineHeight: "Độ dày",
  ...
  cloudSyncTestWarning:
    'Lưu ý: Do Google Drive Sync đang trong giai đoạn thử nghiệm (chưa có domain chính thức), nếu tài khoản của bạn bị chặn đăng nhập hoặc gặp lỗi "Ứng dụng chưa được xác minh", vui lòng <a href="https://docs.google.com/forms/d/e/1FAIpQLSe0MVV6-Z7sxb-4Zpv5wRyBcKPsl8EbOqRAnntgrdBc_gOXpQ/viewform?usp=dialog" target="_blank" style="color: var(--accent-color); text-decoration: underline; font-weight: 600;">nhập email vào form này &nearr;</a> để được cấp quyền dùng thử nhé.',
  cloudSyncTitle: "Sao Lưu & Đồng Bộ Đám Mây",
  cloudSyncSubtitle: "Sao lưu và khôi phục bookmark an toàn giữa các thiết bị.",
  cloudSyncProviderGithub: "GitHub",
  cloudSyncProviderGitlab: "GitLab",
  cloudSyncProviderGdrive: "Google Drive",
  cloudSyncBackupBtn: "Sao lưu lên Cloud",
  cloudSyncRestoreBtn: "Khôi phục từ Cloud",
  cloudSyncTokenLabel: "Personal Access Token (PAT):",
  cloudSyncTokenPlaceholder: "ghp_... hoặc glpat-...",
  cloudSyncGistIdLabel: "Gist ID (không bắt buộc):",
  cloudSyncGistIdPlaceholder: "Để trống để tự động tạo Secret Gist mới",
  cloudSyncGitlabHostLabel: "Địa chỉ máy chủ GitLab:",
  ...
  donateThankYou: "💖 Cảm ơn bạn rất nhiều vì đã đồng hành và ủng hộ dự án!",
  cpTabAll: "Tất cả",
  cpTabBookmarks: "Dấu trang",
  cpTabNotes: "Ghi chú",
  cpTabFolders: "Thư mục",
  cpTabCommands: "Lệnh",
  snoozeBookmark: "Hẹn giờ (Snooze)",
  snoozeTitle: "Hẹn giờ đọc lại",
  snooze1Hour: "Trong 1 giờ",
  snoozeTomorrow: "Ngày mai",
  snoozeNextWeek: "Tuần sau",
  snoozeSuccess: "Đã hẹn giờ đọc sau {0} phút!",
  waybackMachine: "Lịch sử Wayback Machine",
  ...
  analyticsTabHabits: "Thói quen truy cập",
  analyticsTabInsights: "Gợi ý thông minh",
  analyticsTotalBookmarks: "Tổng Bookmarks",
  analyticsTotalFolders: "Tổng Thư mục",
  analyticsAddedThisWeek: "Thêm tuần này",
  analyticsAddedThisMonth: "Thêm tháng này",
  analyticsTaggedRate: "Đã gắn thẻ",
  analyticsNotesRate: "Có ghi chú",
  analyticsFavorites: "Yêu thích",
  analyticsPinned: "Đã ghim",
  analyticsSecurityRate: "Bảo mật HTTPS",
  analyticsLinkHealth: "Sức khỏe liên kết",
  analyticsHealthHealthy: "Hoạt động tốt",
  analyticsHealthBroken: "Bị hỏng",
  analyticsHealthUnchecked: "Chưa kiểm tra",
  analyticsMonthlyTimeline: "Lượng bookmark lưu theo tháng (12 tháng qua)",
  analyticsDayOfWeek: "Hoạt động theo ngày trong tuần",
  analyticsTopDomains: "Top Tên Miền",
  analyticsTopTags: "Thẻ được dùng nhiều nhất",
  analyticsLargestFolders: "Thư mục lớn nhất",
  analyticsMostVisited: "Bookmark xem nhiều nhất",
  analyticsStaleBookmarks: "Bookmark lãng quên (> 6 tháng)",
  analyticsInsightsTitle: "Đề xuất tối ưu hóa",
  analyticsInsightUntagged: "bookmark chưa được gắn thẻ tag.",
  analyticsInsightUntaggedAction: "Gợi ý thẻ ngay",
  analyticsInsightUnsorted: "bookmark chưa được phân loại vào thư mục.",
  ...
  analyticsTimeOfDay: "Phân bổ thời gian trong ngày",
  morning: "Buổi sáng",
  ...
  dayFri: "T6",
  daySat: "T7",
  noDomainData: "Chưa có dữ liệu tên miền",
  noTagsUsed: "Chưa sử dụng thẻ nào",
  noFoldersFound: "Không tìm thấy thư mục",
  noForgottenBookmarks: "Không có bookmark nào bị lãng quên!",
  savedOn: "Đã lưu",
  visits: "lượt xem",
  recent: "Mới lưu",
