export const en = {
  ...
  "localAiGuideSteps": "<div style='text-align:left; line-height:1.6; font-size: 0.95em;'><b>How to enable Chrome Built-in AI:</b><br><br>1. Copy & paste into address bar: <br><code style='background:var(--bg-tertiary);padding:3px 6px;border-radius:4px;user-select:all;'>chrome://flags/#prompt-api</code><br>👉 Set to <b>Enabled</b><br><br>2. Copy & paste: <br><code style='background:var(--bg-tertiary);padding:3px 6px;border-radius:4px;user-select:all;'>chrome://flags/#optimization-guide-on-device-model</code><br>👉 Set to <b>Enabled BypassPerfRequirement</b><br><br>3. Click <b>Relaunch</b> at the bottom right.<br><br><i>Note: On first run, Chrome will download the AI model (~1.5GB). You will see a progress bar in the chat.</i></div>",
  ...
  "smartCleanupConfirmDelete": "Are you sure you want to delete these items? This cannot be undone.",
  ...
  "smartCleanupGuideStartText": "Click any card on the left to review items and take targeted cleanup actions.",
  "smartCleanupGuideMerge": "Merge Duplicates",
  "smartCleanupGuideMergeText": "Combine identical URLs safely. The most recently updated bookmark is always kept.",
  "smartCleanupGuideDead": "Dead Links",
  "smartCleanupGuideDeadText": "Scan and identify bookmarks that are no longer accessible (404, server errors).",
  "smartCleanupGuideOrganize": "Organize Domains",
  "smartCleanupGuideOrganizeText": "Group your most visited domains into organized folders or auto-apply tags.",
  ...
  analyticsDesc: "Your bookmarking habits",
